\section{Application Server}\label{sec:application_server}
...
\figref{fig:application_server_arch} shows the Application Server's
architecture.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{application_server_arch}
